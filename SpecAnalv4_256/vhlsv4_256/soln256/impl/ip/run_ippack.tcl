...
set solution_dir "/home/arjunmenonv/Arjun_acads/Year3/CompOrg/HW-Spectrum-Analyzer/SpecAnalv4/vhlsv4_256/soln256"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 win_mode W 0x0 "Data signal of win_mode" {{0 8 win_mode W 0 "Bit 7 to 0 Data signal of win_mode"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
