...
entity bitreverse_rev_256_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of bitreverse_rev_256_rom is 
...
architecture arch of bitreverse_rev_256 is
    component bitreverse_rev_256_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    bitreverse_rev_256_rom_U :  component bitreverse_rev_256_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
