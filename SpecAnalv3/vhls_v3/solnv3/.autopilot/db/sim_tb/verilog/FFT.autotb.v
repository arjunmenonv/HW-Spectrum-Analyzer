...
initial begin : generate_AESL_ready_cnt_proc
    ...
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.FFT.autotvout_mag_OUT.dat", "r");
    fp2 = $fopen("./impl_rtl.FFT.autotvout_mag_OUT.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.FFT.autotvout_mag_OUT.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.FFT.autotvout_mag_OUT.dat\"!");
    else begin
        $display("Comparing rtl.FFT.autotvout_mag_OUT.dat with impl_rtl.FFT.autotvout_mag_OUT.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
