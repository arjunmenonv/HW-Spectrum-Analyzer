set moduleName Block_codeRepl124_pr
set isTopModule 0
...
set C_modelName {Block_codeRepl124_pr}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_IN int 64 regular {axi_s 0 volatile  { data_IN Data } }  }
	{ xin_M_imag float 32 regular {array 32 { 0 3 } 0 1 }  }
	{ xin_M_real float 32 regular {array 32 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ xin_M_imag_address0 sc_out sc_lv 5 signal 1 } 
	{ xin_M_imag_ce0 sc_out sc_logic 1 signal 1 } 
	{ xin_M_imag_we0 sc_out sc_logic 1 signal 1 } 
	{ xin_M_imag_d0 sc_out sc_lv 32 signal 1 } 
	{ xin_M_real_address0 sc_out sc_lv 5 signal 2 } 
	{ xin_M_real_ce0 sc_out sc_logic 1 signal 2 } 
	{ xin_M_real_we0 sc_out sc_logic 1 signal 2 } 
	{ xin_M_real_d0 sc_out sc_lv 32 signal 2 } 
	{ win_mode_dout sc_in sc_lv 8 signal 3 } 
	{ win_mode_empty_n sc_in sc_logic 1 signal 3 } 
	{ win_mode_read sc_out sc_logic 1 signal 3 } 
	{ win_mode_out_din sc_out sc_lv 8 signal 4 } 
	{ win_mode_out_full_n sc_in sc_logic 1 signal 4 } 
	{ win_mode_out_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	xin_M_imag { ap_memory {  { xin_M_imag_address0 mem_address 1 5 }  { xin_M_imag_ce0 mem_ce 1 1 }  { xin_M_imag_we0 mem_we 1 1 }  { xin_M_imag_d0 mem_din 1 32 } } }
	xin_M_real { ap_memory {  { xin_M_real_address0 mem_address 1 5 }  { xin_M_real_ce0 mem_ce 1 1 }  { xin_M_real_we0 mem_we 1 1 }  { xin_M_real_d0 mem_din 1 32 } } }
