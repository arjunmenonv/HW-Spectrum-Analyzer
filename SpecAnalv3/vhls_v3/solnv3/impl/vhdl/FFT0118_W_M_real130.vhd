...
entity FFT0118_W_M_real130_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of FFT0118_W_M_real130_rom is 
...
architecture arch of FFT0118_W_M_real130 is
    component FFT0118_W_M_real130_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    FFT0118_W_M_real130_rom_U :  component FFT0118_W_M_real130_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
