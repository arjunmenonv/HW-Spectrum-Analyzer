...
// ==============================================================
#ifndef __FFT_faddfsub_32nsfYi__HH__
#define __FFT_faddfsub_32nsfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFT_faddfsub_32nsfYi) {
    ...
    SC_CTOR(FFT_faddfsub_32nsfYi):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
