...
localparam
    ...
    ADDR_DATA_OUT_M_REAL_BASE = 10'h180,
    ADDR_DATA_OUT_M_REAL_HIGH = 10'h1ff,
    ADDR_DATA_OUT_M_IMAG_BASE = 10'h200,
    ADDR_DATA_OUT_M_IMAG_HIGH = 10'h27f,
    WRIDLE                    = 2'd0,
    WRDATA                    = 2'd1,
    WRRESP                    = 2'd2,
    WRRESET                   = 2'd3,
...
assign RVALID  = (rstate == RDDATA) & !int_data_IN_M_real_read & !int_data_IN_M_imag_read & !int_data_OUT_M_real_read & !int_data_OUT_M_imag_read;
