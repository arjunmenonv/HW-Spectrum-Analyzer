...
entity FFT053_W_M_real65_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of FFT053_W_M_real65_rom is 
...
architecture arch of FFT053_W_M_real65 is
    component FFT053_W_M_real65_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    FFT053_W_M_real65_rom_U :  component FFT053_W_M_real65_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
