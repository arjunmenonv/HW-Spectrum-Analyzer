...
struct FFT057 : public sc_module {
    ...
    sc_out< sc_lv<5> > xout_M_real_address0;
    sc_out< sc_logic > xout_M_real_ce0;
    sc_out< sc_logic > xout_M_real_we0;
    sc_out< sc_lv<32> > xout_M_real_d0;
    sc_out< sc_lv<5> > xout_M_real_address1;
    sc_out< sc_logic > xout_M_real_ce1;
    sc_out< sc_logic > xout_M_real_we1;
    sc_out< sc_lv<32> > xout_M_real_d1;
    sc_out< sc_lv<5> > xout_M_imag_address0;
    sc_out< sc_logic > xout_M_imag_ce0;
    sc_out< sc_logic > xout_M_imag_we0;
    sc_out< sc_lv<32> > xout_M_imag_d0;
    sc_out< sc_lv<5> > xout_M_imag_address1;
    sc_out< sc_logic > xout_M_imag_ce1;
    sc_out< sc_logic > xout_M_imag_we1;
    sc_out< sc_lv<32> > xout_M_imag_d1;
    sc_signal< sc_logic > ap_var_for_const0;


    // Module declarations
    FFT057(sc_module_name name);
    SC_HAS_PROCESS(FFT057);

    ~FFT057();

    sc_trace_file* mVcdFile;

    FFT053_W_M_real65* W_M_real_U;
    FFT053_W_M_imag61* W_M_imag_U;
    FFT_fsub_32ns_32nbkb<1,5,32,32,32>* FFT_fsub_32ns_32nbkb_U71;
    FFT_fadd_32ns_32ncud<1,5,32,32,32>* FFT_fadd_32ns_32ncud_U72;
    FFT_fsub_32ns_32nbkb<1,5,32,32,32>* FFT_fsub_32ns_32nbkb_U73;
    FFT_fsub_32ns_32nbkb<1,5,32,32,32>* FFT_fsub_32ns_32nbkb_U74;
    FFT_fadd_32ns_32ncud<1,5,32,32,32>* FFT_fadd_32ns_32ncud_U75;
    FFT_fadd_32ns_32ncud<1,5,32,32,32>* FFT_fadd_32ns_32ncud_U76;
    FFT_fmul_32ns_32ndEe<1,4,32,32,32>* FFT_fmul_32ns_32ndEe_U77;
    FFT_fmul_32ns_32ndEe<1,4,32,32,32>* FFT_fmul_32ns_32ndEe_U78;
    FFT_fmul_32ns_32ndEe<1,4,32,32,32>* FFT_fmul_32ns_32ndEe_U79;
    FFT_fmul_32ns_32ndEe<1,4,32,32,32>* FFT_fmul_32ns_32ndEe_U80;
    ...
    sc_signal< sc_lv<64> > sext_ln58_1_fu_287_p1;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter1_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter2_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter3_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter4_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter5_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter6_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter7_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter8_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter9_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter10_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter11_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter12_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter13_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter14_reg;
    sc_signal< sc_lv<64> > sext_ln58_1_reg_372_pp0_iter15_reg;
    ...
    sc_signal< sc_lv<32> > p_r_M_real_1_reg_470;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter10;
    sc_signal< sc_lv<32> > p_r_M_imag_1_reg_476;
    ...
    sc_signal< sc_lv<32> > complex_M_real_writ_1_reg_492;
    sc_signal< sc_lv<32> > grp_fu_231_p2;
    sc_signal< sc_lv<32> > complex_M_imag_writ_1_reg_497;
    ...
    void thread_icmp_ln61_fu_293_p2();
    void thread_select_ln61_fu_327_p3();
    void thread_sext_ln58_1_fu_287_p1();
    void thread_sext_ln58_fu_281_p1();
    void thread_sext_ln59_fu_343_p1();
    void thread_shl_ln56_fu_263_p2();
    void thread_tmp_1_fu_305_p3();
    void thread_xout_M_imag_address0();
    void thread_xout_M_imag_address1();
    void thread_xout_M_imag_ce0();
    void thread_xout_M_imag_ce1();
    void thread_xout_M_imag_d0();
    void thread_xout_M_imag_d1();
    void thread_xout_M_imag_we0();
    void thread_xout_M_imag_we1();
    void thread_xout_M_real_address0();
    void thread_xout_M_real_address1();
    void thread_xout_M_real_ce0();
    void thread_xout_M_real_ce1();
    void thread_xout_M_real_d0();
    void thread_xout_M_real_d1();
    void thread_xout_M_real_we0();
    void thread_xout_M_real_we1();
