...
#ifndef _Block_codeRepl11320_s_HH_
#define _Block_codeRepl11320_s_HH_
...
struct Block_codeRepl11320_s : public sc_module {
    ...
    sc_in< sc_lv<32> > xout_M_imag_q0;
    sc_out< sc_lv<5> > xout_M_real_address0;
    sc_out< sc_logic > xout_M_real_ce0;
    sc_in< sc_lv<32> > xout_M_real_q0;


    // Module declarations
    Block_codeRepl11320_s(sc_module_name name);
    SC_HAS_PROCESS(Block_codeRepl11320_s);
