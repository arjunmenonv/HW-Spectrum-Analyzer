...
entity bitreverse_rev_32_rom is 
    generic(
             DWIDTH     : integer := 5; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of bitreverse_rev_32_rom is 
...
architecture arch of bitreverse_rev_32 is
    component bitreverse_rev_32_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    bitreverse_rev_32_rom_U :  component bitreverse_rev_32_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
