...
architecture behav of FFT056 is 
    ...
    signal W_M_real62_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal W_M_real62_ce0 : STD_LOGIC;
    signal W_M_real62_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal W_M_imag58_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal W_M_imag58_ce0 : STD_LOGIC;
    signal W_M_imag58_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sext_ln58_2_fu_289_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter1_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter2_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter3_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter4_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter5_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter6_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter7_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter8_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter9_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter10_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter11_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter12_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter13_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter14_reg : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln58_2_reg_372_pp0_iter15_reg : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    W_M_real62_U : component FFT053_W_M_real65
    generic map (
        DataWidth => 32,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    W_M_imag58_U : component FFT053_W_M_imag61
    generic map (
        DataWidth => 32,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    FFT_fsub_32ns_32nbkb_U57 : component FFT_fsub_32ns_32nbkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    FFT_fadd_32ns_32ncud_U58 : component FFT_fadd_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    FFT_fsub_32ns_32nbkb_U59 : component FFT_fsub_32ns_32nbkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    FFT_fsub_32ns_32nbkb_U60 : component FFT_fsub_32ns_32nbkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    FFT_fadd_32ns_32ncud_U61 : component FFT_fadd_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    FFT_fadd_32ns_32ncud_U62 : component FFT_fadd_32ns_32ncud
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    FFT_fmul_32ns_32ndEe_U63 : component FFT_fmul_32ns_32ndEe
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    FFT_fmul_32ns_32ndEe_U64 : component FFT_fmul_32ns_32ndEe
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    FFT_fmul_32ns_32ndEe_U65 : component FFT_fmul_32ns_32ndEe
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    FFT_fmul_32ns_32ndEe_U66 : component FFT_fmul_32ns_32ndEe
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    W_M_imag58_address0 <= sext_ln58_fu_283_p1(4 - 1 downto 0);

    W_M_imag58_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter0)
    begin
    ...
    W_M_real62_address0 <= sext_ln58_fu_283_p1(4 - 1 downto 0);

    W_M_real62_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter0)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    data_OUT3_M_imag_address0 <= sext_ln58_2_fu_289_p1(5 - 1 downto 0);
    data_OUT3_M_imag_address1 <= sext_ln59_fu_343_p1(5 - 1 downto 0);
    ...
    data_OUT3_M_real_address0 <= sext_ln58_2_fu_289_p1(5 - 1 downto 0);
    data_OUT3_M_real_address1 <= sext_ln59_fu_343_p1(5 - 1 downto 0);
    ...
    data_OUT4_M_imag_address0 <= sext_ln58_2_reg_372_pp0_iter15_reg(5 - 1 downto 0);
    data_OUT4_M_imag_address1 <= sext_ln59_reg_442_pp0_iter15_reg(5 - 1 downto 0);
    ...
    data_OUT4_M_imag_d1 <= complex_M_imag_writ_2_reg_497;

    data_OUT4_M_imag_we0_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln53_reg_348_pp0_iter15_reg, ap_enable_reg_pp0_iter16)
    begin
    ...
    data_OUT4_M_imag_we1_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln53_reg_348_pp0_iter15_reg, ap_enable_reg_pp0_iter16)
    begin
        if (((ap_enable_reg_pp0_iter16 = ap_const_logic_1) and (icmp_ln53_reg_348_pp0_iter15_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    data_OUT4_M_real_address0 <= sext_ln58_2_reg_372_pp0_iter15_reg(5 - 1 downto 0);
    data_OUT4_M_real_address1 <= sext_ln59_reg_442_pp0_iter15_reg(5 - 1 downto 0);
    ...
    data_OUT4_M_real_d1 <= complex_M_real_writ_2_reg_492;

    data_OUT4_M_real_we0_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln53_reg_348_pp0_iter15_reg, ap_enable_reg_pp0_iter16)
    begin
        if (((ap_enable_reg_pp0_iter16 = ap_const_logic_1) and (icmp_ln53_reg_348_pp0_iter15_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    data_OUT4_M_real_we1_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln53_reg_348_pp0_iter15_reg, ap_enable_reg_pp0_iter16)
    begin
        if (((ap_enable_reg_pp0_iter16 = ap_const_logic_1) and (icmp_ln53_reg_348_pp0_iter15_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    icmp_ln61_fu_295_p2 <= "1" when (signed(butterfly_span_0_i_reg_174) < signed(ap_const_lv32_7)) else "0";
    icmp_ln63_fu_307_p2 <= "1" when (signed(butterfly_pass_0_i_reg_185) < signed(ap_const_lv32_1)) else "0";
    ...
    select_ln61_fu_327_p3 <= 
        ...
        ap_const_lv32_0;
        sext_ln58_2_fu_289_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(Llimit_fu_277_p2),64));
    ...
    shl_ln56_fu_265_p2 <= std_logic_vector(shift_left(unsigned(butterfly_pass_0_i_reg_185),to_integer(unsigned('0' & ap_const_lv32_4(31-1 downto 0)))));
end behav;
