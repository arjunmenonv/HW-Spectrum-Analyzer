...
set IPName      "FFT"
set Version     "2.1"
set DisplayName "FFT32_v2.1"
set Revision    "2012291237"
set Description "FFT32 float AXILITE pipelined"
set Device      "zynq"
set AutoFamily  ""
...
set solution_dir "/home/arjunmenonv/Arjun_acads/Year3/CompOrg/HW-Spectrum-Analyzer/SpecAnalv2/soln_v2"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {bitreverse_rev_32
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        memories "data_IN_M_real {base_address 128 range 128} data_IN_M_imag {base_address 256 range 128} data_OUT_M_real {base_address 384 range 128} data_OUT_M_imag {base_address 512 range 128}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
