...
set ID 90
set hasByteEnable 0
set MemName FFT_data_OUT0_M_reOg_memcore
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 32
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName FFT_data_OUT0_M_reOg
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
set ID 91
set hasByteEnable 0
set MemName FFT_data_OUT1_M_ig8j_memcore
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 32
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName FFT_data_OUT1_M_ig8j
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
set ID 92
set hasByteEnable 0
set MemName FFT_xout_M_real_memcore
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 32
