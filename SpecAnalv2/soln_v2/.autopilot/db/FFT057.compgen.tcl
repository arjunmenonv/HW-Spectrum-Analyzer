...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { xout_M_real_address0 { O 5 vector } xout_M_real_ce0 { O 1 bit } xout_M_real_we0 { O 1 bit } xout_M_real_d0 { O 32 vector } xout_M_real_address1 { O 5 vector } xout_M_real_ce1 { O 1 bit } xout_M_real_we1 { O 1 bit } xout_M_real_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { xout_M_imag_address0 { O 5 vector } xout_M_imag_ce0 { O 1 bit } xout_M_imag_we0 { O 1 bit } xout_M_imag_d0 { O 32 vector } xout_M_imag_address1 { O 5 vector } xout_M_imag_ce1 { O 1 bit } xout_M_imag_we1 { O 1 bit } xout_M_imag_d1 { O 32 vector } } \
} "
} else {
