...
// ==============================================================
#ifndef __FFT_faddfsub_32nscud__HH__
#define __FFT_faddfsub_32nscud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FFT_faddfsub_32nscud) {
    ...
    SC_CTOR(FFT_faddfsub_32nscud):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
