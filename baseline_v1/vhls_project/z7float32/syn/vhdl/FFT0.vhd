...
architecture behav of FFT0 is 
    ...
    signal zext_ln33_fu_297_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln33_reg_424 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln35_fu_311_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln35_reg_429 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_321_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_reg_437 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal index_fu_327_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal index_reg_442 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln26_fu_315_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal Ulimit_fu_337_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal Ulimit_reg_447 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln33_fu_373_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln33_reg_453 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sext_ln30_1_fu_398_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln30_1_reg_473 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal sext_ln31_fu_404_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln31_reg_521 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal butterfly_span_0_reg_180 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state20 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state20 : signal is "none";
    signal butterfly_pass_0_reg_191 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_0_reg_202 : STD_LOGIC_VECTOR (4 downto 0);
    signal sext_ln30_fu_393_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal trunc_ln33_fu_287_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln33_fu_291_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal trunc_ln35_fu_301_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln35_fu_305_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal shl_ln28_fu_332_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln35_fu_354_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal butterfly_pass_fu_359_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln33_fu_343_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal butterfly_span_fu_348_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    butterfly_pass_0_reg_191_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    butterfly_span_0_reg_180_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state20)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ...
                    zext_ln33_reg_424(4 downto 0) <= zext_ln33_fu_297_p1(4 downto 0);
                    zext_ln35_reg_429(4 downto 0) <= zext_ln35_fu_311_p1(4 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln26_fu_315_p2 = ap_const_lv1_0))) then
    ...
    zext_ln33_reg_424(31 downto 5) <= "000000000000000000000000000";
    zext_ln35_reg_429(31 downto 5) <= "000000000000000000000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln26_fu_315_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln26_fu_315_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    Ulimit_fu_337_p2 <= std_logic_vector(unsigned(butterfly_span_0_reg_180) + unsigned(shl_ln28_fu_332_p2));
    W_M_imag_address0 <= sext_ln30_fu_393_p1(4 - 1 downto 0);
    ...
    W_M_real_address0 <= sext_ln30_fu_393_p1(4 - 1 downto 0);
    ...
    add_ln33_fu_291_p2 <= std_logic_vector(signed(ap_const_lv5_1F) + signed(trunc_ln33_fu_287_p1));
    add_ln35_fu_305_p2 <= std_logic_vector(signed(ap_const_lv5_1F) + signed(trunc_ln35_fu_301_p1));
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln26_fu_315_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln26_fu_315_p2 = ap_const_lv1_1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln26_fu_315_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln26_fu_315_p2 = ap_const_lv1_1))) then 
    ...
    butterfly_pass_1_fu_365_p3 <= 
        butterfly_pass_fu_359_p2 when (icmp_ln35_fu_354_p2(0) = '1') else 
        ap_const_lv32_0;
    butterfly_pass_2_fu_381_p3 <= 
        butterfly_pass_0_reg_191 when (icmp_ln33_fu_343_p2(0) = '1') else 
        butterfly_pass_1_fu_365_p3;
    butterfly_pass_fu_359_p2 <= std_logic_vector(unsigned(butterfly_pass_0_reg_191) + unsigned(ap_const_lv32_1));
    butterfly_span_fu_348_p2 <= std_logic_vector(unsigned(butterfly_span_0_reg_180) + unsigned(ap_const_lv32_1));

    data_IN_M_imag_address0_assign_proc : process(ap_CS_fsm_state3, sext_ln30_1_fu_398_p1, sext_ln31_fu_404_p1, ap_CS_fsm_state12)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
            data_IN_M_imag_address0 <= sext_ln31_fu_404_p1(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            data_IN_M_imag_address0 <= sext_ln30_1_fu_398_p1(5 - 1 downto 0);
        else 
    ...
    data_IN_M_real_address0_assign_proc : process(ap_CS_fsm_state3, sext_ln30_1_fu_398_p1, sext_ln31_fu_404_p1, ap_CS_fsm_state12)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
            data_IN_M_real_address0 <= sext_ln31_fu_404_p1(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            data_IN_M_real_address0 <= sext_ln30_1_fu_398_p1(5 - 1 downto 0);
        else 
    ...
    data_OUT_M_imag_address0_assign_proc : process(sext_ln30_1_reg_473, sext_ln31_reg_521, ap_CS_fsm_state20, ap_CS_fsm_state19)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state20)) then 
            data_OUT_M_imag_address0 <= sext_ln31_reg_521(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state19)) then 
            data_OUT_M_imag_address0 <= sext_ln30_1_reg_473(5 - 1 downto 0);
        else 
    ...
    data_OUT_M_real_address0_assign_proc : process(sext_ln30_1_reg_473, sext_ln31_reg_521, ap_CS_fsm_state20, ap_CS_fsm_state19)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state20)) then 
            data_OUT_M_real_address0 <= sext_ln31_reg_521(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state19)) then 
            data_OUT_M_real_address0 <= sext_ln30_1_reg_473(5 - 1 downto 0);
        else 
    ...
    i_fu_321_p2 <= std_logic_vector(unsigned(i_0_reg_202) + unsigned(ap_const_lv5_1));
    icmp_ln26_fu_315_p2 <= "1" when (i_0_reg_202 = ap_const_lv5_10) else "0";
    icmp_ln33_fu_343_p2 <= "1" when (signed(butterfly_span_0_reg_180) < signed(zext_ln33_reg_424)) else "0";
    icmp_ln35_fu_354_p2 <= "1" when (signed(butterfly_pass_0_reg_191) < signed(zext_ln35_reg_429)) else "0";
    index_fu_327_p2 <= std_logic_vector(shift_left(unsigned(butterfly_span_0_reg_180),to_integer(unsigned('0' & index_shift_cast_reg_414(31-1 downto 0)))));
    ...
    select_ln33_fu_373_p3 <= 
        butterfly_span_fu_348_p2 when (icmp_ln33_fu_343_p2(0) = '1') else 
        ap_const_lv32_0;
        sext_ln30_1_fu_398_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(Llimit_fu_389_p2),64));

        sext_ln30_fu_393_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(index_reg_442),64));

        sext_ln31_fu_404_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(Ulimit_reg_447),64));

    shl_ln28_fu_332_p2 <= std_logic_vector(shift_left(unsigned(butterfly_pass_0_reg_191),to_integer(unsigned('0' & pass_shift_cast_reg_409(31-1 downto 0)))));
    trunc_ln33_fu_287_p1 <= FFT_stage(5 - 1 downto 0);
    trunc_ln35_fu_301_p1 <= pass_check(5 - 1 downto 0);
    zext_ln33_fu_297_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln33_fu_291_p2),32));
    zext_ln35_fu_311_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln35_fu_305_p2),32));
end behav;
