...
//------------------------Parameter----------------------
`define TV_IN_data_IN_M_real "../tv/cdatafile/c.FFT.autotvin_data_IN_M_real.dat"
`define TV_IN_data_IN_M_imag "../tv/cdatafile/c.FFT.autotvin_data_IN_M_imag.dat"
`define TV_OUT_data_OUT_M_real "../tv/rtldatafile/rtl.FFT.autotvout_data_OUT_M_real.dat"
`define TV_OUT_data_OUT_M_imag "../tv/rtldatafile/rtl.FFT.autotvout_data_OUT_M_imag.dat"
...
parameter data_OUT_M_real_data_out_addr = 384;
parameter data_OUT_M_imag_data_out_addr = 512;
...
assign TRAN_AXILiteS_read_data_finish = 1 & data_OUT_M_real_read_data_finish & data_OUT_M_imag_read_data_finish;
assign TRAN_AXILiteS_write_data_finish = 1 & data_IN_M_real_write_data_finish & data_IN_M_imag_write_data_finish;
