...
architecture behave of FFT_AXILiteS_s_axi is
    ...
    constant ADDR_DATA_OUT_M_REAL_BASE : INTEGER := 16#180#;
    constant ADDR_DATA_OUT_M_REAL_HIGH : INTEGER := 16#1ff#;
    constant ADDR_DATA_OUT_M_IMAG_BASE : INTEGER := 16#200#;
    constant ADDR_DATA_OUT_M_IMAG_HIGH : INTEGER := 16#27f#;
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_data_IN_M_real_read = '0') and (int_data_IN_M_imag_read = '0') and (int_data_OUT_M_real_read = '0') and (int_data_OUT_M_imag_read = '0') else '0';
    RVALID    <= RVALID_t;
